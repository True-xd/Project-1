...
.stButton>button { background-color:#3498db;color:white;border-radius:8px;height:3em;width:100%;font-size:16px;margin-bottom:5px; }
</style>
    ...
    if st.session_state.page == "Citizen":
        ...
        if st.button("Submit Issue"):
            if title and location:
                add_issue(title, description, location, priority)
